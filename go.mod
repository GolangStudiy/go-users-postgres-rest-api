...
require (
	github.com/GolangStudiy/go-users-postgres-rest-api/databaseclient v0.0.0-00010101000000-000000000000
	github.com/GolangStudiy/go-users-postgres-rest-api/postgrescontainer v0.0.0-00010101000000-000000000000
)
